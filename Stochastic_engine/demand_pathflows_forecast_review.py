...
plt.plot(simulated, label='Predicted ')
plt.plot(BPA_y, label='Actual')
plt.title('BPA Electricity Deamnd',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)

plt.yticks(fontname = "Arial",fontsize=13)
plt.xticks(fontname = "Arial",fontsize=13)

plt.xlim([0,2555])
plt.legend(loc='upper right', prop= {'family':'Arial' , 'size':'13'})

plt.savefig('Plots/BPA_demand.png', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(simulated, label='Predicted ')
plt.plot(SDGE_y, label='Actual')
plt.title('SDGE Electricity Deamnd',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/SDGE_demand.png', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(simulated, label='Predicted ')
plt.plot(SCE_y, label='Actual')
plt.title('SCE Electricity Deamnd',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/SCE_demand.png', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(simulated, label='Predicted ')
plt.plot(PGEV_y, label='Actual')
plt.title('PGEV Electricity Deamnd',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/PGEV_demand.png', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(simulated, label='Predicted ')
plt.plot(PGEB_y, label='Actual')
plt.title('PGEB Electricity Deamnd',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/PGEB_demand.png', bbox_inches='tight',dpi=250)
...
# fig = plt.figure(figsize = (10,7))
# plt.plot(predicted, label='Predicted Flow')
# plt.plot(Path46_y, label='Historical Flow')
# plt.title('Path 46')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/Path_46_time_serries', bbox_inches='tight',dpi=250)


fig = plt.figure(figsize = (10,7))
plt.plot(predicted, label='Predicted ')
plt.plot(Path46_y, label='Actual')
plt.title('Path 46',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path46_flow.png', bbox_inches='tight',dpi=250)
...
# fig = plt.figure(figsize = (10,7))
# plt.scatter(NWPaths_p,NWPaths_y)
# plt.title('MWPaths')
# plt.xlabel('Predicted')
# plt.ylabel('Historical Data')

# plt.savefig('Plots/MWPath_scatter', bbox_inches='tight',dpi=250)


fig = plt.figure(figsize = (10,7))
plt.plot(NWPaths_p[:,0], label='Predicted ')
plt.plot(NWPaths_y[:,0], label='Actual')
plt.title('Path 8',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Patht_8_flow1.png', bbox_inches='tight',dpi=250)


fig = plt.figure(figsize = (10,7))
plt.plot(NWPaths_p[:,1], label='Predicted ')
plt.plot(NWPaths_y[:,1], label='Actual')
plt.title('Path 14',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Patht_14_flow2.png', bbox_inches='tight',dpi=250)


fig = plt.figure(figsize = (10,7))
plt.plot(NWPaths_p[:,2], label='Predicted ')
plt.plot(NWPaths_y[:,2], label='Actual')
plt.title('NW Paths',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Patht_3_flow3.png', bbox_inches='tight',dpi=250)


# fig = plt.figure(figsize = (10,7))
# plt.plot(NWPaths_p[:,0], label='Predicted Fllow')
# plt.plot(NWPaths_y[:,0], label='Historical Fllow')
# plt.title('MWPaths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/MWPath_time_serries1', bbox_inches='tight',dpi=250)

# fig = plt.figure(figsize = (10,7))
# plt.plot(NWPaths_p[:,1], label='Predicted Fllow')
# plt.plot(NWPaths_y[:,1], label='Historical Fllow')
# plt.title('MWPaths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/MWPath_time_serries2', bbox_inches='tight',dpi=250)

# fig = plt.figure(figsize = (10,7))
# plt.plot(NWPaths_p[:,2], label='Predicted Fllow')
# plt.plot(NWPaths_y[:,2], label='Historical Fllow')
# plt.title('MWPaths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()
...
# fig = plt.figure(figsize = (10,7))
# plt.scatter(OtherCA_Paths_p,OtherCA_Paths_y)
# plt.title('OtherCA_Paths')
# plt.xlabel('Predicted')
# plt.ylabel('Historical Data')

# plt.savefig('Plots/OtherCA_Paths_scatter', bbox_inches='tight',dpi=250)




fig = plt.figure(figsize = (10,7))
plt.plot(OtherCA_Paths_p[:,0], label='Predicted ')
plt.plot(OtherCA_Paths_y[:,0], label='Actual')
plt.title('Paths 61',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_61_flow1.png', bbox_inches='tight',dpi=250)




fig = plt.figure(figsize = (10,7))
plt.plot(OtherCA_Paths_p[:,1], label='Predicted ')
plt.plot(OtherCA_Paths_y[:,1], label='Actual')
plt.title('Path 42',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_42_flow2.png', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(OtherCA_Paths_p[:,2], label='Predicted ')
plt.plot(OtherCA_Paths_y[:,2], label='Actual')
plt.title('Path 24',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_24_flow3.png', bbox_inches='tight',dpi=250)




fig = plt.figure(figsize = (10,7))
plt.plot(OtherCA_Paths_p[:,3], label='Predicted ')
plt.plot(OtherCA_Paths_y[:,3], label='Actual')
plt.title('Path 45',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_45_flow4.png', bbox_inches='tight',dpi=250)
...
# fig = plt.figure(figsize = (10,7))
# plt.plot(OtherCA_Paths_p[:,0], label='Predicted Fllow')
# plt.plot(OtherCA_Paths_y[:,0], label='Historical Fllow')
# plt.title('OtherCA_Paths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/OtherCA_Paths_time_serries1', bbox_inches='tight',dpi=250)


# fig = plt.figure(figsize = (10,7))
# plt.plot(OtherCA_Paths_p[:,1], label='Predicted Fllow')
# plt.plot(OtherCA_Paths_y[:,1], label='Historical Fllow')
# plt.title('OtherCA_Paths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/OtherCA_Paths_time_serries2', bbox_inches='tight',dpi=250)

# fig = plt.figure(figsize = (10,7))
# plt.plot(OtherCA_Paths_p[:,2], label='Predicted Fllow')
# plt.plot(OtherCA_Paths_y[:,2], label='Historical Fllow')
# plt.title('OtherCA_Paths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/OtherCA_Paths_time_serries3', bbox_inches='tight',dpi=250)


# fig = plt.figure(figsize = (10,7))
# plt.plot(OtherCA_Paths_p[:,3], label='Predicted Fllow')
# plt.plot(OtherCA_Paths_y[:,3], label='Historical Fllow')
# plt.title('OtherCA_Paths')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/OtherCA_Paths_time_serries4', bbox_inches='tight',dpi=250)
...
# fig = plt.figure(figsize = (10,7))
# plt.scatter(Path65_66_p,Path65_66_y)
# plt.title('Path65_66')
# plt.xlabel('Predicted')
# plt.ylabel('Historical Data')

# plt.savefig('Plots/Path65_66_scatter', bbox_inches='tight',dpi=250)
...
fig = plt.figure(figsize = (10,7))
plt.plot(Path65_66_p[:,0], label='Predicted ')
plt.plot(Path65_66_y[:,0], label='Actual')
plt.title('Path 65',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_65_flow1.png', bbox_inches='tight',dpi=250)



fig = plt.figure(figsize = (10,7))
plt.plot(Path65_66_p[:,1], label='Predicted ')
plt.plot(Path65_66_y[:,1], label='Actual')
plt.title('Path 66',fontsize=14,**csfont)
plt.xlabel('Day',fontsize=14,**csfont)
plt.ylabel('MWh',fontsize=14,**csfont)
...
plt.savefig('Plots/Path_66_flow1.png', bbox_inches='tight',dpi=250)
...
# fig = plt.figure(figsize = (10,7))
# plt.plot(Path65_66_p[:,0], label='Predicted Fllow')
# plt.plot(Path65_66_y[:,0], label='Historical Fllow')
# plt.title('Path65_66')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/Path65_66_time_serries1', bbox_inches='tight',dpi=250)


# fig = plt.figure(figsize = (10,7))
# plt.plot(Path65_66_p[:,1], label='Predicted Fllow')
# plt.plot(Path65_66_y[:,1], label='Historical Fllow')
# plt.title('Path65_66')
# plt.xlabel('Day')
# plt.ylabel('MWh')
# plt.legend()

# plt.savefig('Plots/Path65_66_time_serries2', bbox_inches='tight',dpi=250)
